...
const file_room_proto_rawDesc = "" +
	...
	"\n" +
	"CreateRoom\x12\".steamvc.room.v1.CreateRoomRequest\x1a#.steamvc.common.v1.StandardResponse\"\x1e\x82\xd3\xe4\x93\x02\x18:\x01*\"\x13/api/v1/room/create\x12|\n" +
	"\n" +
...
var file_room_proto_goTypes = []any{
	...
	(*DeleteRoomRequest)(nil), // 5: steamvc.room.v1.DeleteRoomRequest
	(*StandardResponse)(nil),  // 6: steamvc.common.v1.StandardResponse
}
var file_room_proto_depIdxs = []int32{
	...
	5, // 4: steamvc.room.v1.RoomService.DeleteRoom:input_type -> steamvc.room.v1.DeleteRoomRequest
	3, // 5: steamvc.room.v1.RoomService.GetRoom:output_type -> steamvc.room.v1.GetRoomResponse
	6, // 6: steamvc.room.v1.RoomService.CreateRoom:output_type -> steamvc.common.v1.StandardResponse
	6, // 7: steamvc.room.v1.RoomService.DeleteRoom:output_type -> steamvc.common.v1.StandardResponse
